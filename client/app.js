...
$(document).ready(function () {
    ...
    populateSelect("api/get_job_titles", "#uiJobTitle", "Job title");
    populateSelect("api/get_company_locations", "#uicompanylocs", "Location", true);
    populateSelect("api/get_currency", "#uicurrency", "Currency", true);
    populateSelect("api/get_work_year", "#uiworkyear", "Work year");
    populateSelect("api/get_employee_residence", "#uiempresidence", "Residence");
